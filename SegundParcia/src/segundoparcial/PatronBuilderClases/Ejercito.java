 ...
 * @author Docente
 */
public class Ejercito implements segundoparcial.PatronBuilderInterfaz.CrearSoldado{
    private int vida;
    ...
    public String toString(){
       return "Un ejercito ha sido creado con las siguientes especificaciones: Nombre: " + nombre + ", Vida: "
