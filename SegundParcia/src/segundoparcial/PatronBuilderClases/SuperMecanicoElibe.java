 ...
 * @author Docente
 */
public class SuperMecanicoElibe implements segundoparcial.PatronBuilderInterfaz.SuperMecanico{
    private SuperVehiculo SuperVehiculo;

    public SuperMecanicoElibe(){
    ...
    public void asignarNombre() {
        SuperVehiculo.setNombre("Super vehiculo Elibe");
    }
