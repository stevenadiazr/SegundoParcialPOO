 ...
 * @author Docente
 */
public class SuperVehiculo implements segundoparcial.PatronBuilderInterfaz.CrearVehiculo{
    private int vida;
    ...
    public String toString(){
       return "Un super vehiculo ha sido creado con las siguientes especificaciones: Nombre: " + nombre + ", Vida: "
