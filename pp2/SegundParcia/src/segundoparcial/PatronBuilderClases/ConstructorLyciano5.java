 ...
 * @author Docente
 */
public class ConstructorLyciano5 implements segundoparcial.PatronBuilderInterfaz.Constructor{
    private Edificio edificio;

    public ConstructorLyciano5(){
    ...
    public void asignarNombre() {
        edificio.setNombre("Edificio de veehiculos");
    }
